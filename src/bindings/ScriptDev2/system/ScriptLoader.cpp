...
// FSS
extern void AddSC_cocoon_warsong();
extern void AddSC_proto_egg_creature();
extern void AddSC_boss_cyanigosa();
extern void AddSC_add_drakkari();
extern void AddSC_mob_sladran();
extern void AddSC_boss_eck();
extern void AddSC_boss_allyhorde();
extern void AddSC_instance_violethold();
...
extern void AddSC_infinite_epoch();
...
extern void AddSC_boss_EDCBeasts();
...
extern void AddSC_instance_toc10();
extern void AddSC_boss_championEdCRaid();
...
void AddScripts()
{
	...
	// FSS
	// Borean Tundra
	AddSC_cocoon_warsong();
	AddSC_boss_cyanigosa();
	AddSC_add_drakkari();
	AddSC_mob_sladran();
	AddSC_boss_eck();
	AddSC_boss_allyhorde();
	AddSC_instance_violethold();
	AddSC_boss_moragg();
	...
	AddSC_instance_toc10();
	AddSC_boss_championEdCRaid();
