...
enum
{
	...
	SPELL_LEECHING_SWARM_10			= 66118,
	SPELL_LEECHING_SWARM_10_H		= 67630,
	SPELL_LEECHING_SWARM_25			= 68646,
	SPELL_LEECHING_SWARM_25_H		= 68647,
	SPELL_PENETRATING_COLD_10		= 66013,
	SPELL_PENETRATING_COLD_10_H		= 67700,
	SPELL_PENETRATING_COLD_25		= 68509,
	SPELL_PENETRATING_COLD_25_H		= 68510,
	...
	SPELL_ACID_MANDIBLE_10			= 67861,
	SPELL_ACID_MANDIBLE_OTHERS		= 66092,
    ...
    void Reset()
    {
		...
		switch(difficulty)
		{
			case RAID_DIFFICULTY_10MAN_NORMAL:
				Tasks.AddEvent(SPELL_PENETRATING_COLD_10,20000,30000,0,TARGET_RANDOM,1);
				Tasks.AddEvent(SPELL_PENETRATING_COLD_10,20000,30000,0,TARGET_RANDOM,3);
				Tasks.AddEvent(SPELL_LEECHING_SWARM_10,10000,30000,0,TARGET_RANDOM,3);
				break;
			case RAID_DIFFICULTY_25MAN_NORMAL:
				Tasks.AddEvent(SPELL_PENETRATING_COLD_25,20000,30000,0,TARGET_RANDOM,1);
				Tasks.AddEvent(SPELL_PENETRATING_COLD_25,20000,30000,0,TARGET_RANDOM,3);
				Tasks.AddEvent(SPELL_LEECHING_SWARM_25,10000,30000,0,TARGET_RANDOM,3);
				break;
			case RAID_DIFFICULTY_10MAN_HEROIC:
				Tasks.AddEvent(SPELL_PENETRATING_COLD_10_H,20000,30000,0,TARGET_RANDOM,1);
				Tasks.AddEvent(SPELL_PENETRATING_COLD_10_H,20000,30000,0,TARGET_RANDOM,3);
				Tasks.AddEvent(SPELL_LEECHING_SWARM_10_H,10000,30000,0,TARGET_RANDOM,3);
				break;
			case RAID_DIFFICULTY_25MAN_HEROIC:
				Tasks.AddEvent(SPELL_PENETRATING_COLD_25_H,20000,30000,0,TARGET_RANDOM,1);
				Tasks.AddEvent(SPELL_PENETRATING_COLD_25_H,20000,30000,0,TARGET_RANDOM,3);
				Tasks.AddEvent(SPELL_LEECHING_SWARM_25_H,10000,30000,0,TARGET_RANDOM,3);
				break;
		}
		Tasks.AddSummonEvent(NPC_BURROWER,70000,100000,1);
			...
			if (!lPlayers.isEmpty())
			{
				for(Map::PlayerList::const_iterator itr = lPlayers.begin(); itr != lPlayers.end(); ++itr)
				{
					if (Player* pPlayer = itr->getSource())
						if(pPlayer->isAlive())
							if(pPlayer->HasAura(66118) || pPlayer->HasAura(67630) || pPlayer->HasAura(68646) || pPlayer->HasAura(68647))
							{
...
struct MANGOS_DLL_DECL mob_swarm_scarabAI : public ScriptedAI
{
    ...
    void Reset()
    {
		...
		{
			case RAID_DIFFICULTY_10MAN_NORMAL:
				Tasks.AddEvent(SPELL_ACID_MANDIBLE_10,5000,20000,0,TARGET_MAIN);
				break;
			case RAID_DIFFICULTY_25MAN_NORMAL:
			case RAID_DIFFICULTY_10MAN_HEROIC:
			case RAID_DIFFICULTY_25MAN_HEROIC:
				Tasks.AddEvent(SPELL_ACID_MANDIBLE_OTHERS,5000,20000,0,TARGET_MAIN);
				break;
		}
