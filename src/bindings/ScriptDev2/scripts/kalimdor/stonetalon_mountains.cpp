    ...
    void WaypointReached(uint32 uiPointId)
    {
        switch(uiPointId)
        {
            ...
            case 16:
                ...
                me->SummonCreature(NPC_GRIMTOTEM_RUFFIAN, -50.75, -500.77, -46.13, 0.4, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 30000);
                me->SummonCreature(NPC_GRIMTOTEM_BRUTE, -40.05, -510.89,- 46.05, 1.7, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 30000);
                me->SummonCreature(NPC_GRIMTOTEM_SORCERER, -32.21, -499.20, -45.35, 2.8, TEMPSUMMON_CORPSE_TIMED_DESPAWN, 30000);
                break;
            // Award quest credit
            case 18:
