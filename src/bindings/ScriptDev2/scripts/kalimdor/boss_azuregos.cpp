...
struct MANGOS_DLL_DECL boss_azuregosAI : public LibDevFSAI
{
    ...
    { 
		InitBoss();
		AddEvent(SPELL_MARKOFFROST,35000,25000,0,TARGET_MAIN);
		AddEvent(SPELL_CHILL,urand(10000,30000),13000,12000,TARGET_MAIN);
		AddEvent(SPELL_FROSTBREATH,4000,10000,5000,TARGET_MAIN);
		AddEvent(SPELL_MANASTORM,urand(5000,17000),7500,5000);
		AddEvent(SPELL_REFLECT,urand(15000,30000),20000,15000,TARGET_ME);
		AddEvent(SPELL_CLEAVE,7000,7000,0,TARGET_MAIN);
	}
