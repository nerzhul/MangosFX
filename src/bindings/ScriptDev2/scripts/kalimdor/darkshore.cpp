...
struct MANGOS_DLL_DECL npc_kerlonianAI : public FollowerAI
{
    ...
    void SetSleeping()
    {
        ...
        switch(urand(0, 2))
        {
            case 0: DoScriptText(EMOTE_KER_SLEEP_1, me); break;
            case 1: DoScriptText(EMOTE_KER_SLEEP_2, me); break;
            case 2: DoScriptText(EMOTE_KER_SLEEP_3, me); break;
        }

        switch(urand(0, 3))
        {
            case 0: DoScriptText(SAY_KER_SLEEP_1, me); break;
            case 1: DoScriptText(SAY_KER_SLEEP_2, me); break;
            case 2: DoScriptText(SAY_KER_SLEEP_3, me); break;
            case 3: DoScriptText(SAY_KER_SLEEP_4, me); break;
        }
