...
struct MANGOS_DLL_DECL npc_ame01AI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 uiPointId)
    {
        ...
        {
            case 0:
                DoScriptText(SAY_AME_START, me);
                break;
            case 19:
                DoScriptText(SAY_AME_PROGRESS, me);
                break;
            case 37:
                DoScriptText(SAY_AME_END, me);
    ...
    void Aggro(Unit* pWho)
    {
        ...
        if (Player* pPlayer = GetPlayerForEscort())
        {
            ...
            switch(urand(0, 2))
            {
                case 0: DoScriptText(SAY_AME_AGGRO1, me); break;
                case 1: DoScriptText(SAY_AME_AGGRO2, me); break;
                case 2: DoScriptText(SAY_AME_AGGRO3, me); break;
            }
        }
    }
};
...
struct MANGOS_DLL_DECL npc_ringoAI : public FollowerAI
{
    ...
    void SetFaint()
    {
        if (!HasFollowState(STATE_FOLLOW_POSTEVENT))
        {
            ...
            switch(urand(0, 3))
            {
                case 0: DoScriptText(SAY_FAINT_1, me); break;
                case 1: DoScriptText(SAY_FAINT_2, me); break;
                case 2: DoScriptText(SAY_FAINT_3, me); break;
                case 3: DoScriptText(SAY_FAINT_4, me); break;
            }
        }
    ...
    void ClearFaint()
    {
        ...
        switch(urand(0, 3))
        {
            case 0: DoScriptText(SAY_WAKE_1, me); break;
            case 1: DoScriptText(SAY_WAKE_2, me); break;
            case 2: DoScriptText(SAY_WAKE_3, me); break;
            case 3: DoScriptText(SAY_WAKE_4, me); break;
        }
