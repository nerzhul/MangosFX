...
struct MANGOS_DLL_DECL boss_chrono_lord_dejaAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        {
            DoCastVictim( m_bIsHeroic ? H_SPELL_ARCANE_BLAST : SPELL_ARCANE_BLAST);
        ...
        if (ArcaneDischarge_Timer < diff)
        {
            ...
            DoCast(target, m_bIsHeroic ? H_SPELL_ARCANE_DISCHARGE : SPELL_ARCANE_DISCHARGE);
            ArcaneDischarge_Timer = urand(20000, 30000);
