    ...
    void UpdateAI(const uint32 uiDiff)
    {
        ...
        if (!me->getVictim())
        {
            ...
            if (m_uiSay_Timer < uiDiff)
            {
                ...
                switch(urand(0, 4))
                {
                    case 0: DoScriptText(SAY_RANDOM_0, me); break;
                    case 1: DoScriptText(SAY_RANDOM_1, me); break;
                    case 2: DoScriptText(SAY_RANDOM_2, me); break;
                    case 3: DoScriptText(SAY_RANDOM_3, me); break;
                    case 4: DoScriptText(SAY_RANDOM_4, me); break;
                }
