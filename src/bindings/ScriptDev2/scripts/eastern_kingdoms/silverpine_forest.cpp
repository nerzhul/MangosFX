...
struct MANGOS_DLL_DECL npc_deathstalker_erlandAI : public npc_escortAI
{
    ...
    void WaypointReached(uint32 i)
    {
        ...
        {
            case 0:
                DoScriptText(SAY_START_2, me, pPlayer);
                break;
            case 13:
                DoScriptText(SAY_END, me, pPlayer);
                pPlayer->GroupEventHappens(QUEST_ERLAND, me);
                break;
            case 14:
                if (Unit* pRane = Unit::GetUnit(*me, uiRaneGUID))
                    DoScriptText(SAY_RANE, pRane, me);
                break;
            case 15:
                DoScriptText(SAY_RANE_REPLY, me);
                break;
            case 16:
                DoScriptText(SAY_CHECK_NEXT, me);
                break;
            case 24:
                DoScriptText(SAY_QUINN, me);
                break;
            case 25:
                if (Unit* pQuinn = Unit::GetUnit(*me, uiQuinnGUID))
                    DoScriptText(SAY_QUINN_REPLY, pQuinn, me);
                break;
            case 26:
                DoScriptText(SAY_BYE, me);
                break;
        }
    }
    ...
    void Aggro(Unit* who)
    {
        switch(urand(0, 2))
        {
            ...
            case 2: DoScriptText(SAY_AGGRO_3, me, who); break;
        }
    }
};
