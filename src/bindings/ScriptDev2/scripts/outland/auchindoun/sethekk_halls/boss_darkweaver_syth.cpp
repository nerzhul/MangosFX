...
struct MANGOS_DLL_DECL boss_darkweaver_sythAI : public ScriptedAI
{
    ...
    void SythSummoning()
    {
        ...
        DoCastMe(SPELL_SUMMON_SYTH_ARCANE,true);   //front
        DoCastMe(SPELL_SUMMON_SYTH_FIRE,true);     //back
        DoCastMe(SPELL_SUMMON_SYTH_FROST,true);    //left
        DoCastMe(SPELL_SUMMON_SYTH_SHADOW,true);   //right
    }
