...
struct MANGOS_DLL_DECL boss_high_botanist_freywinnAI : public ScriptedAI
{
    ...
    void DoSummonSeedling()
    {
        switch(urand(0, 3))
        {
            case 0: DoCastMe(SPELL_PLANT_WHITE); break;
            case 1: DoCastMe(SPELL_PLANT_GREEN); break;
            case 2: DoCastMe(SPELL_PLANT_BLUE); break;
            case 3: DoCastMe(SPELL_PLANT_RED); break;
        }
    }
    ...
    void UpdateAI(const uint32 diff)
    {
        ...
        {
            DoScriptText(urand(0, 1) ? SAY_TREE_1 : SAY_TREE_2, me);
            ...
            DoCastMe(SPELL_SUMMON_FRAYER,true);
            DoCastMe(SPELL_TRANQUILITY,true);
            DoCastMe(SPELL_TREE_FORM,true);
