...
INSTANTIATE_SINGLETON_1( ClusterQuest );
volatile bool ClusterQuest::m_stopEvent = false;
uint8 ClusterQuest::m_ExitCode = SHUTDOWN_EXIT_CODE;

ClusterQuest::ClusterQuest()
{
}
...
void ClusterQuest::SetInitialSettings()
{
	///- Time server startup
...
void ClusterQuest::LoadConfigSettings()
{
}

void ClusterQuest::Wait()
{
	while(!MustStop())
	{
