...
enum HighGuid
{
	...
	HIGHGUID_GROUP          = 0x1F50,						// Merging

};

#define IS_EMPTY_GUID(Guid)          ( Guid == 0 )

#define IS_CREATURE_GUID(Guid)       ( GUID_HIPART(Guid) == HIGHGUID_UNIT || IS_VEHICLE_GUID(Guid))
#define IS_PET_GUID(Guid)            ( GUID_HIPART(Guid) == HIGHGUID_PET )
#define IS_VEHICLE_GUID(Guid)        ( GUID_HIPART(Guid) == HIGHGUID_VEHICLE )
#define IS_CREATURE_OR_PET_GUID(Guid)( IS_CREATURE_GUID(Guid) || IS_PET_GUID(Guid) || IS_VEHICLE_GUID(Guid))
...
#define IS_GROUP(Guid)               (GUID_HIPART(Guid) == HIGHGUID_GROUP) // Merging
