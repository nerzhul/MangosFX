...
enum WorldConfigs
{
	...
	CONFIG_QUEST_DAILY_RESET_HOUR,
	CONFIG_QUEST_WEEKLY_RESET_WEEK_DAY,
	CONFIG_QUEST_WEEKLY_RESET_HOUR,
...
class World
{
    public:
        ...
        /// Uptime (in secs)
        uint32 GetUptime() const { return uint32(m_gameTime - m_startTime + m_savedUptime); }
        ...
        {
            return index < 1 ? m_states[index] : 0;
        }
