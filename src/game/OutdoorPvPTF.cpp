...
bool OutdoorPvPTF::Update(uint32 diff)
{
    ...
    if(changed = OutdoorPvP::Update(diff))
    {
        ...
        {
            TeamApplyBuff(BG_TEAM_ALLIANCE, TF_CAPTURE_BUFF);
            m_IsLocked = true;
        ...
        {
            TeamApplyBuff(BG_TEAM_HORDE, TF_CAPTURE_BUFF);
            m_IsLocked = true;
            SendUpdateWorldState(TF_UI_LOCKED_DISPLAY_NEUTRAL,uint32(0));
        ...
        {
            TeamCastSpell(BG_TEAM_ALLIANCE, -TF_CAPTURE_BUFF);
            TeamCastSpell(BG_TEAM_HORDE, -TF_CAPTURE_BUFF);
        }
...
void OPvPCapturePointTF::ChangeState()
{
    ...
    if( m_OldState == OBJECTIVESTATE_ALLIANCE )
    {
        ...
        sWorld.SendZoneText(OutdoorPvPTFBuffZones[0],sObjectMgr.GetMangosStringForDBCLocale(0/*LANG_OPVP_TF_LOOSE_A*/));
    }
    ...
    else if ( m_OldState == OBJECTIVESTATE_HORDE )
    {
        ...
        sWorld.SendZoneText(OutdoorPvPTFBuffZones[0],sObjectMgr.GetMangosStringForDBCLocale(0/*LANG_OPVP_TF_LOOSE_H*/));
    }
    ...
    case OBJECTIVESTATE_ALLIANCE:
        ...
        if(((OutdoorPvPTF*)m_PvP)->m_AllianceTowersControlled<TF_TOWER_NUM)
            ((OutdoorPvPTF*)m_PvP)->m_AllianceTowersControlled++;
        sWorld.SendZoneText(OutdoorPvPTFBuffZones[0],sObjectMgr.GetMangosStringForDBCLocale(0/*LANG_OPVP_TF_CAPTURE_A*/));
        break;
    case OBJECTIVESTATE_HORDE:
        ...
        if(((OutdoorPvPTF*)m_PvP)->m_HordeTowersControlled<TF_TOWER_NUM)
            ((OutdoorPvPTF*)m_PvP)->m_HordeTowersControlled++;
        sWorld.SendZoneText(OutdoorPvPTFBuffZones[0],sObjectMgr.GetMangosStringForDBCLocale(0/*LANG_OPVP_TF_CAPTURE_H*/));
        break;
