...
enum Opcodes
{
    ...
    CMSG_UPDATE_PROJECTILE_POSITION                               = 0x4BE, // CMSG, missle?
    SMSG_SET_PROJECTILE_POSITION                               = 0x4BF, // SMSG, uint64, uint8, 3 x float
    ...
    SMSG_CORPSE_NOT_IN_INSTANCE                     = 0x506, // ERR_CORPSE_IS_NOT_IN_INSTANCE = 0x1A8,
    ...
    SMSG_REDIRECT_CLIENT                               = 0x50D, // not found - disconnect
    ...
    SMSG_COMBAT_LOG_MULTIPLE                               = 0x514, // SMSG
