...
class MANGOS_DLL_SPEC WorldSession
{
    ...
    public:
		...
		AuctionHouseEntry const* GetCheckedAuctionHouseForAuctioneer(uint64 guid);
    ...
    public:                                                 // opcodes handlers
		...
		void HandleLFDPlayerLockRequest(WorldPacket& recv_data);
		void HandleLFDPartyLockRequest(WorldPacket& recv_data);
		void HandleLFDPlayerLockResponse();
