...
const uint32 HP_LANG_LOOSE_A[HP_TOWER_NUM] = {0,0,0/*LANG_OPVP_HP_LOOSE_BROKENHILL_A,LANG_OPVP_HP_LOOSE_OVERLOOK_A,LANG_OPVP_HP_LOOSE_STADIUM_A*/};

const uint32 HP_LANG_LOOSE_H[HP_TOWER_NUM] = {0,0,0/*LANG_OPVP_HP_LOOSE_BROKENHILL_H,LANG_OPVP_HP_LOOSE_OVERLOOK_H,LANG_OPVP_HP_LOOSE_STADIUM_H*/};

const uint32 HP_LANG_CAPTURE_A[HP_TOWER_NUM] = {0,0,0/*LANG_OPVP_HP_CAPTURE_BROKENHILL_A,LANG_OPVP_HP_CAPTURE_OVERLOOK_A,LANG_OPVP_HP_CAPTURE_STADIUM_A*/};

const uint32 HP_LANG_CAPTURE_H[HP_TOWER_NUM] = {0,0,0/*LANG_OPVP_HP_CAPTURE_BROKENHILL_H,LANG_OPVP_HP_CAPTURE_OVERLOOK_H,LANG_OPVP_HP_CAPTURE_STADIUM_H*/};
...
bool OutdoorPvPHP::Update(uint32 diff)
{
    ...
    {
        if(m_AllianceTowersControlled == 3)
            TeamApplyBuff(BG_TEAM_ALLIANCE, AllianceBuff, HordeBuff);
        else if(m_HordeTowersControlled == 3)
            TeamApplyBuff(BG_TEAM_HORDE, HordeBuff, AllianceBuff);
        else
        {
            TeamCastSpell(BG_TEAM_ALLIANCE, -AllianceBuff);
            TeamCastSpell(BG_TEAM_HORDE, -HordeBuff);
        }
...
void OPvPCapturePointHP::ChangeState()
{
    ...
    GameObject* flag = sMapMgr.FindMap(530)->GetGameObject(m_capturePointGUID);
    GameObject* flag2 = sMapMgr.FindMap(530)->GetGameObject(m_Objects[m_TowerType]);
    if(flag)
    {
