...
#define SPELL_ATTR_EX_NO_SPELL_ATTR_EX_NO_INITIAL_AGGRO            0x00000400            // 10 no generates threat on cast 100%
...
#define SPELL_ATTR_EX_NO_INITIAL_AGGRO            0x00020000            // 17
...
enum Mechanics
{
    ...
    MECHANIC_GRIP             = 6,
    MECHANIC_ROOT             = 7,
    MECHANIC_SLOWATTACK       = 8,                          //0 spells use this mechanic
    MECHANIC_SILENCE          = 9,
    MECHANIC_SLEEP            = 10,
    MECHANIC_SNARE            = 11,
    MECHANIC_STUN             = 12,
...
enum Targets
{
    ...
    TARGET_PERIODIC_TRIGGER_AURA       = 77,
...
enum LFGInstanceTypes
{
	LFG_NORMAL_MODE		=	0x03010000,
	LFG_HEROIC_MODE		=	0x03050000,
	LFG_RANDOM_DUNGEON	=	0x03060001,
	LFG_RANDOM_NORMAL	=	0x05010000,
