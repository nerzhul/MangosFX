...
public:
    ...
    virtual void ChangeTeam(BattleGroundTeamId oldTeam) {}
...
public:
    ...
    void TeamApplyBuff(BattleGroundTeamId team, uint32 spellId, uint32 spellId2 = 0);
protected:
    ...
    void TeamCastSpell(BattleGroundTeamId team, int32 spellId);
};
