/* OutDoorPVP Redesigned by Frost Sapphire Studios */
...
void OutdoorPvPMgr::InitOutdoorPvP()
{
	...
	*/
    ...
    if(!pOP->SetupOutdoorPvP())
    {
        sLog.outError("OutdoorPvP : Wintergrasp init failed.");
        delete pOP;
    }
    else
    {
        m_OutdoorPvPSet.push_back(pOP);
        sLog.outError("OutdoorPvP : Wintergrasp successfully initiated.");
    }
}
