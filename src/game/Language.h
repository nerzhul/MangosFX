...
enum MangosStrings
{
	...
	LANG_BG_SA_START_ONE_MINUTE			= 690,
	LANG_BG_SA_START_HALF_MINUTE		= 691,
	LANG_BG_SA_HAS_BEGUN				= 692,
...
//                                      = 749, not used
	...
	LANG_BG_WG_BATTLE_STARTS            = 2956,
    LANG_BG_WG_DEFENDED                 = 2957,
    LANG_BG_WG_CAPTURED                 = 2958,
    LANG_BG_WG_WORKSHOP_DAMAGED         = 2959,
    LANG_BG_WG_WORKSHOP_DESTROYED       = 2960,
    LANG_BG_WG_TOWER_DAMAGED            = 2961,
    LANG_BG_WG_TOWER_DESTROYED          = 2962,
    LANG_BG_WG_FORTRESS_UNDER_ATTACK    = 2963,
    LANG_BG_WG_SWITCH_FACTION           = 2964,
    LANG_BG_WG_CHANGE_TIMER             = 2965,
    LANG_BG_WG_BATTLE_FORCE_START       = 2966,
    LANG_BG_WG_BATTLE_FORCE_STOP        = 2967,
    LANG_BG_WG_STATUS                   = 2968,
    LANG_BG_WG_DISABLE                  = 2969,
    LANG_BG_WG_ENABLE                   = 2970,
    LANG_BG_WG_RANK1                    = 2971,
    LANG_BG_WG_RANK2                    = 2972,
